...
export const Card = ({ title, count, icon, increase = null, color = "primary" }) => {
  return (
    <div className="bg-[var(--card-bg)] rounded-lg shadow-sm p-6 transition-all hover:shadow-md">
      ...
      <div className="flex items-end">
        <span className="text-3xl font-bold text-neutral-950">{count}</span>
        {increase !== null && (
...
export default function Dashboard() {
  ...
  const userStats = [
    {
      ...
      count: 1210,
      increase: 15,
      icon: <Users className="h-5 w-5 text-neutral-950 " />,
    },
    {
      title: "Maintenance Team",
      count: 58,
      increase: 10,
      icon: <PenTool className="h-5 w-5 text-neutral-950 " />,
    },
    {
      title: "Administrators",
      count: 8,
      increase: 5,
      icon: <Settings className="h-5 w-5 text-neutral-950 " />,
    },
  ]
  ...
  const requestStats = [
    {
      title: "Total Request",
      count: 50,
      icon: <FileText className="h-5 w-5 text-neutral-950 " />,
    },
    {
      title: "Accepted Request",
      count: 32,
      icon: <CheckCircle className="h-5 w-5 text-neutral-950 " />,
    },
    {
      title: "Refused Request",
      count: 18,
      icon: <XCircle className="h-5 w-5 text-neutral-950 " />,
    },
  ]
  ...
  return (
    <div className="bg-neutral-50  p-6">
      ...
      {/* Title */}
      <h1 className="text-2xl font-bold text-neutral-950 mb-6">
